...
class CalendarController < ApplicationController
  ...
  def index
    ...
    last_day        = @show_month.end_of_month
    @events         = Event.find(:all,:conditions => ["(start_date >= ? && end_date <= ?) || (start_date <= ? && end_date <= ?) || (start_date>=? && end_date>=?) || (start_date<=? && end_date>=?) ", first_day, last_day, first_day, last_day, first_day, last_day, first_day, last_day])
    load_notifications
  end
  ...
  def show_event_tooltip
    ...
    common_event        = Event.find_all_by_is_common_and_is_holiday(true, false, :conditions => ["(start_date >= ? && end_date <= ?) || (start_date <= ? && end_date <= ?)  || (start_date >= ? && end_date >= ?) || (start_date <= ? && end_date >= ?)", first_day, last_day, first_day, last_day, first_day, last_day, first_day, last_day])
    non_common_events   = Event.find_all_by_is_common_and_is_holiday_and_is_exam_and_is_due(false, false, false, false, :conditions => ["(start_date >= ? && end_date <= ?) || (start_date <= ? && end_date <= ?) || (start_date >= ? && end_date >= ?) || (start_date <= ? && end_date >= ?) ", first_day, last_day, first_day, last_day, first_day, last_day, first_day, last_day])
    @common_event_array = []
  ...
  def show_holiday_event_tooltip
    ...
    common_holiday_event      = Event.find_all_by_is_common_and_is_holiday(true, true, :conditions => ["(start_date >= ? && end_date <= ?) || (start_date <= ? && end_date <= ?) || (start_date >= ? && end_date >= ?) || (start_date <= ? && end_date >= ?)", first_day, last_day, first_day, last_day, first_day, last_day, first_day, last_day])
    non_common_holiday_events = Event.find_all_by_is_common_and_is_holiday(false, true, :conditions => ["(start_date >= ? && end_date <= ?) || (start_date <= ? && end_date <= ?) || (start_date >= ? && end_date >= ?) || (start_date <= ? && end_date >= ?)", first_day, last_day, first_day, last_day, first_day, last_day, first_day, last_day])
  ...
  def show_exam_event_tooltip
    ...
    first_day = @date.beginning_of_month.to_time
    last_day  = @date.end_of_month.to_time
    not_common_exam_event = Event.find_all_by_is_common_and_is_holiday_and_is_exam(false, false, true, :conditions => ["(start_date >= ? && end_date <= ?) || (start_date <= ? && end_date <= ?) || (start_date >= ? && end_date >= ?) || (start_date <= ? && end_date >= ?)", first_day, last_day, first_day, last_day, first_day, last_day, first_day, last_day])
